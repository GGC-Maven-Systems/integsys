...
public class InvRequest_EntryControllerMC implements Initializable, ScreenInterface {
    ...
    private TextField tfTransactionNo, tfBrand, tfModel, tfInvType, tfSourceNo,
            tfVariant, tfColor, tfROQ, tfClassification, tfQOH,  tfReservationQTY, tfOrderQuantity, tfSearchTransNo, tfSearchReferenceNo;
...
//            System.exit(1);
    ...
    private void setOrderQuantityToDetail(String fsValue) {
        double roq = invRequestController.Detail(pnTblInvDetailRow).getRecommendedOrder();
        double quantity = invRequestController.Detail(pnTblInvDetailRow).getQuantity();
