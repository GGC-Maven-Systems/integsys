 ...
 * @author User
 */
public class InvRequest_Roq_ConfirmationControllerCar_SP implements Initializable, ScreenInterface {
...
//                    }
                     {
                        try {
                            ...
                            Logger.getLogger(InvRequest_Roq_ConfirmationControllerCar_SP.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
    ...
    private void initFields(int fnEditMode) {
        ...
        if (invRequestController.Master().getTransactionStatus().equals(StockRequestStatus.OPEN)
            ...
            CustomCommonUtil.setDisable(true,
                    tfInvType, dpTransactionDate, tfReferenceNo, tfReservationQTY,
