 ...
 * @author User
 */
public class InvRequest_EntryControllerMP implements Initializable, ScreenInterface {
...
//                            invRequestController.Detail(pnTblInvDetailRow).Inventory().setBrandId(brandID);
                        ...
                        case "tfModel":
                            ...
                            poJSON = invRequestController.SearchModel(lsValue, false, brandID, pnTblInvDetailRow);
...
//            System.exit(1);
    ...
    private void initTableInvDetail() {
        ...
        tblBarCodeDetail.setCellValueFactory(new PropertyValueFactory<>("index04"));
    ...
    private void initTextFieldFocus() {
        List<TextField> loTxtField = Arrays.asList(tfOrderQuantity, tfSearchReferenceNo, tfOrderQuantity, tfBrand, tfDescription, tfModel, tfSourceNo); //tfReferenceNo, 
