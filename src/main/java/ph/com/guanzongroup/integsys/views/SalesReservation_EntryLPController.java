 ...
 * @author user
 */
public class SalesReservation_EntryLPController implements Initializable, ScreenInterface {

    private GRiderCAS poApp;
    private SalesControllers poSalesControllers;
    private String psFormName = "Sales Reservation Entry LP";
...
//                                    
                                ...
                                tfDescription.setText(poSalesControllers.SalesReservation().Detail(pnDetailRow).Inventory().getDescription());
                                tfQuantity.requestFocus();
                                loadTableDetailList();
                                loadRecordDetail();
                                 break;
...
//            
            ...
            System.out.println("Inventory MODEL ID : " + poSalesControllers.SalesReservation().Detail(pnDetailRow).Inventory().getModelId());
            System.out.println("MODEL ID : " + poSalesControllers.SalesReservation().Detail(pnDetailRow).Inventory().Model().getModelId());
            System.out.println("description  : " + poSalesControllers.SalesReservation().Detail(pnDetailRow).Inventory().Model().getDescription());
            tfModel.setText(poSalesControllers.SalesReservation().Detail(pnDetailRow).Model().getDescription());
