 ...
 * @author Team 2
 */
public class SalesInquiry_EntryMonarchFoodController implements Initializable, ScreenInterface {
    ...
    @FXML
    private Button btnAddClient, btnBrowse, btnNew, btnUpdate, btnSearch, btnSave, btnCancel, btnVoid, btnHistory, btnClose;
    @FXML
    private TextField tfTransactionNo, tfBranch, tfSalesPerson, tfClient, tfAddress, tfContactNo, tfInquiryType, tfReferralAgent, tfBarcode, tfDescription, tfBrand, tfMeasure, tfSellingPrice;
    @FXML
...
//                            poSalesInquiryController.SalesInquiry().initFields();
    ...
    public void loadRecordDetail() {
        try {
            ...
            tfMeasure.setText(poSalesInquiryController.SalesInquiry().Detail(pnDetail).Inventory().Measure().getDescription());
