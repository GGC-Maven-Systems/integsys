 ...
 * @author Team 1
 */
public class POReturnPosting_HistoryAppliancesController implements Initializable, ScreenInterface {
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        try {
            ...
            Logger.getLogger(POReturnPosting_HistoryAppliancesController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
