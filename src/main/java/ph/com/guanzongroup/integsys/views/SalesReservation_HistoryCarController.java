 ...
 * @author user
 */
public class SalesReservation_HistoryCarController implements Initializable, ScreenInterface {
    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        if (source instanceof Button) {
            ...
            try {
                ...
                Logger.getLogger(SalesReservation_HistoryCarController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
