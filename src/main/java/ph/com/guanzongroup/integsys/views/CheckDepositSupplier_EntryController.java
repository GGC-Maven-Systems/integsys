...
public class CheckDepositSupplier_EntryController implements Initializable, ScreenInterface {
    ...
    @FXML
    private AnchorPane AnchorMain, apBrowse, apButton, apMaster, apDetail, apAttachments, apAttachmentButtons, apTransaction;
    @FXML
    ...
    @FXML
    private TextField tfTransactionNo, tfBankMaster, tfBankAccountNo, tfBankAccountName, tfTotal, tfCheckTransNo, tfBank, tfPayee, tfNote, tfCheckNo, tfCheckAmount, tfAttachmentNo, tfSearchBank;
    @FXML
    private DatePicker dpTransactionDate, dpTransactionReferDate, dpCheckDate, dpFrom, dpThru;
    @FXML
    private TextArea taRemarks;
    @FXML
    private CheckBox cbReverse;
    @FXML
    private TableView tblViewDetail, tblAttachments, tblViewMain;
    @FXML
    private TableColumn tblColDetailNo, tblColDetailReference, tblColDetailBank, tblColDetailPayee, tblColDetailDate, tblColDetailCheckNo, tblColDetailCheckAmount, tblRowNoAttachment, tblFileNameAttachment, tblColNo, tblColTransNo, tblColTransDate, tblColCheckNo, tblColCheckAmount;
    @FXML
...
//                    poController.Master().setBranchCode(oApp.getBranchCode());
                ...
                case "btnUpdate":
                    ...
                    break;
                case "btnSearch":
                    JFXUtil.initiateBtnSearch(pxeModuleName, lastFocusedTextField, previousSearchedTextField, apBrowse, apMaster, apDetail, apTransaction);
                    break;
                case "btnSave":
...
//                        loadTableMain.reload();
    ...
    private void initDatePicker() {
        JFXUtil.setDatePickerFormat("MM/dd/yyyy", dpTransactionDate, dpTransactionReferDate, dpCheckDate, dpFrom, dpThru);
        JFXUtil.setActionListener(datepicker_Action, dpTransactionDate, dpTransactionReferDate, dpCheckDate, dpFrom, dpThru);
    }
    ...
    private void initTextFields() {
        ...
        JFXUtil.setKeyPressedListener(this::txtField_KeyPressed, apTransaction, apMaster, apDetail, apTransaction);
        JFXUtil.setKeyEventFilter(tableKeyEvents, tblViewDetail, tblAttachments, tblViewMain);
        JFXUtil.adjustColumnForScrollbar(tblViewDetail, tblAttachments, tblViewMain);
    ...
    private void initButton(int fnValue) {
        ...
        JFXUtil.setDisabled(!lbShow1, apBrowse, apMaster, apDetail, apAttachments);
