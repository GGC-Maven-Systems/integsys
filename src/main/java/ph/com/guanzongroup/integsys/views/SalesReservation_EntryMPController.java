...
import ph.com.guanzongroup.cas.sales.SalesReservation.StockSummary;
 ...
 * @author user
 */
public class SalesReservation_EntryMPController implements Initializable, ScreenInterface {

    private GRiderCAS poApp;
    private SalesControllers poSalesControllers;
    private String psFormName = "Sales Reservation Entry MP";
    ...
    private void initObject() {
        try {
            ...
            System.out.println("inits : " + psIndustryID + " "
                    + poSalesControllers.SalesReservation().Master().getIndustryID());
...
//                            loadTableSourceList();
                    ...
                    case "tfQuantity":
                        ...
                        try {
                            ...
                            poSalesControllers.SalesReservation().Detail(pnDetailRow).setQuantity(qty);
                            poSalesControllers.SalesReservation().Detail(pnDetailRow).isReversed(false);
...
//                                fakeClickOnTable(tblDetailList, pnDetailRow + 1);
            ...
            Logger.getLogger(SalesReservation_EntryMPController.class
                ...
                switch (clickedButton.getId()) {
                    ...
                    case "btnCancel":
                        if (ShowMessageFX.YesNo("Are you sure you want to cancel?", "Computerized Acounting System", psFormName)) {
                            poSalesControllers.SalesReservation().Master().setClientID(null);
                            poSalesControllers.SalesReservation().Master().setClientID(null);
                            clearMaster();
                            clearDetail();
                            detail_data.clear();
        ...
        Task<Void> task = new Task<Void>() {
            ...
            protected Void call() throws Exception {
                ...
                Platform.runLater(() -> {
                    try {
                        source_data.clear();
                        poJSON = poSalesControllers.SalesReservation().getUnifiedSource(poSalesControllers.SalesReservation().Master().getClientID());
                        if ("success".equals(poJSON.get("result"))) {
...
//            initDetailFocus();
        ...
        protected Void call() {
            Platform.runLater(() -> {
                try {
                    ...
                    List<StockSummary> summaries = poSalesControllers.SalesReservation().computeStockSummaries();
    ...
    private void initButton(int fnValue) {
        ...
        tfModel.setEditable(lbShow);       
        tfBarcode.setEditable(lbShow); 
        tfDescription.setEditable(lbShow);
