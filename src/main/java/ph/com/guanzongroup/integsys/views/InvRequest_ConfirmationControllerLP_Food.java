 ...
 * @author User
 */
public class InvRequest_ConfirmationControllerLP_Food implements Initializable, ScreenInterface {
    ...
    private TextField tfTransactionNo, tfBrand, tfInvType, tfROQ, tfClassification, tfQOH,  tfReservationQTY,
            tfOrderQuantity, tfSearchTransNo, tfSearchReferenceNo, tfDescription, tfBarCode, tfMeasure, tfSourceNo;
...
//                    }
    ...
    private void clearDetailFields() {
        /* Detail Fields*/
        CustomCommonUtil.setText("", tfBrand, tfBarCode, tfDescription,
                tfReservationQTY, tfQOH, tfInvType, tfROQ, tfClassification);
