 ...
 * @author Team 1
 */
public class POReturnPosting_HistorySPCarController implements Initializable, ScreenInterface {
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        try {
            ...
            Logger.getLogger(POReturnPosting_HistorySPCarController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
