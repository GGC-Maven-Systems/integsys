 ...
 * @author Team 1
 */
public class CheckDepositSupplier_ConfirmationController implements Initializable, ScreenInterface {
    ...
    @FXML
    private TableColumn tblColDetailNo, tblColDetailReference, tblColDetailBank, tblColDetailPayee, tblColDetailDate, tblColDetailCheckNo, tblColDetailCheckAmount, tblRowNoAttachment, tblFileNameAttachment, tblColNo, tblColTransNo, tblColTransDate, tblColBankAccountNo, tblColBankAccountNme;
    @FXML
...
//                            }
    ...
    private void initDatePicker() {
        JFXUtil.setDatePickerFormat("MM/dd/yyyy", dpSearchTransactionDate, dpTransactionDate, dpTransactionReferDate, dpCheckDate);
        JFXUtil.setActionListener(datepicker_Action, dpSearchTransactionDate, dpTransactionDate, dpTransactionReferDate, dpCheckDate);
    ...
    private void initTextFields() {
        ...
        JFXUtil.setKeyPressedListener(this::txtField_KeyPressed, apBrowse, apMaster, apDetail, apTransaction);
    ...
    private void clearTextFields() {
        ...
        JFXUtil.clearTextFields(apTransaction, apMaster, apDetail, apAttachments);
    }
}
