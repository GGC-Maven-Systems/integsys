 ...
 * @author User
 */
public class InvRequest_ConfirmationControllerAppliances implements Initializable, ScreenInterface {
    ...
    private TextField tfTransactionNo, tfBrand, tfModel, tfInvType,
            ...
            tfOrderQuantity, tfSearchTransNo, tfSearchReferenceNo, tfDescription, tfBarCode, tfSourceNo;
...
//                    tfReferenceNo);
            ...
            CustomCommonUtil.setDisable(true,
                    ...
                    tfQOH, tfROQ, dpTransactionDate, tfClassification, tfVariant, tfColor, tfBrand, tfModel, tfBarCode, tfDescription);
            CustomCommonUtil.setDisable(!lbShow, tfOrderQuantity, taRemarks, tfSourceNo); //tfReferenceNo, 
