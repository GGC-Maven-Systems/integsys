 ...
 */
public class AccountsAccreditation_EntryController implements Initializable, ScreenInterface {
    ...
    @FXML
    private Button btnBrowse, btnSearch, btnNew, btnUpdate, btnSave, btnCancel, btnHistory, btnClose, btnAddClompany, btnAddAttachment, btnRemoveAttachment, btnArrowLeft, btnArrowRight;
    @FXML
...
//        psCategoryID = fsValue;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        try {
            ...
            ShowMessageFX.Error(null, pxeModuleName, MiscUtil.getException(e));
        }
    }
                ...
                switch (event.getCode()) {
                    ...
                    case F3:
                        switch (txtFieldID) {
                            ...
                            case "tfCompany":
                                if (!isJSONSuccess(
                                        poController.searchCompany(tfCompany.getText(), false),
