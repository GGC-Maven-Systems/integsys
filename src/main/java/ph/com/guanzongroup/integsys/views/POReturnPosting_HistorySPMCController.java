 ...
 * @author Team 1
 */
public class POReturnPosting_HistorySPMCController implements Initializable, ScreenInterface {
    ...
    private void txtField_KeyPressed(KeyEvent event) {
        try {
            ...
            Logger.getLogger(POReturnPosting_HistorySPMCController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
