 ...
 * @author user
 */
public class SalesReservation_HistorySPCarController implements Initializable, ScreenInterface {

    private GRiderCAS poApp;
    private SalesControllers poSalesControllers;
    private String psFormName = "Sales Reservation History SPCar";
    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        if (source instanceof Button) {
            ...
            try {
                ...
                Logger.getLogger(SalesReservation_HistorySPCarController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
