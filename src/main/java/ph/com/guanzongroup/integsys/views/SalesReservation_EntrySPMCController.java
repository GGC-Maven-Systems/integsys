 ...
 * @author user
 */
public class SalesReservation_EntrySPMCController implements Initializable, ScreenInterface {

    private GRiderCAS poApp;
    private SalesControllers poSalesControllers;
    private String psFormName = "Sales Reservation Entry SPMC";
...
//                                fakeClickOnTable(tblDetailList, pnDetailRow + 1);
            ...
            Logger.getLogger(SalesReservation_EntrySPMCController.class
