 ...
 * @author Team 2
 */
public class POReplacement_ConfirmationMonarchFoodController implements Initializable, ScreenInterface {
    ...
    @FXML
    private TextField tfSearchSupplier, tfSearchReferenceNo, tfTransactionNo, tfSupplier, tfTrucking, tfReferenceNo, tfTerm, tfDiscountRate, tfDiscountAmount, tfTotal, tfOrderNo, tfBarcode, tfDescription, tfSupersede, tfCost, tfReceiveQuantity, tfBrand, tfColor, tfMeasure, tfInventoryType, tfOrderQuantity, tfModel, tfAttachmentNo;
    @FXML
