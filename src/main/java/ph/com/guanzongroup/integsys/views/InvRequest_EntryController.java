 ...
 * @author User
 */
public class InvRequest_EntryController implements Initializable, ScreenInterface {
...
//        });
    ...
    private void loadRecordSearch() {
        try {
            ...
            lblSource.setText(invRequestController.Master().Company().getCompanyName());
...
//                    }
    ...
    private void clearMasterFields() {
        ...
        taRemarks.setText("");
        CustomCommonUtil.setText("", tfTransactionNo, tfSourceNo);
...
//                            invRequestController.Detail(pnTblInvDetailRow).Inventory().setBrandId(brandID);
                        ...
                        case "tfBarCode":
                            ...
                            poJSON = invRequestController.SearchBarcodeGeneral(lsValue, true, pnTblInvDetailRow, brandID
                            );
                        ...
                        case "tfDescription":
                            ...
                            poJSON = invRequestController.SearchBarcodeDescriptionGeneral(lsValue, false, pnTblInvDetailRow, brandID
                            );
                            if ("error".equals(poJSON.get("result"))) {
                                ShowMessageFX.Warning((String) poJSON.get("message"), psFormName, null);
