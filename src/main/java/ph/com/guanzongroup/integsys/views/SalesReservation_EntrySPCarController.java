 ...
 * @author user
 */
public class SalesReservation_EntrySPCarController implements Initializable, ScreenInterface {

    private GRiderCAS poApp;
    private SalesControllers poSalesControllers;
    private String psFormName = "Sales Reservation Entry SPCar";
...
//                                fakeClickOnTable(tblDetailList, pnDetailRow + 1);
            ...
            Logger.getLogger(SalesReservation_EntrySPCarController.class
