 ...
 * @author user
 */
public class SalesReservation_HistoryLPController implements Initializable, ScreenInterface {
    ...
    private void handleButtonAction(ActionEvent event) {
        ...
        if (source instanceof Button) {
            ...
            try {
                ...
                Logger.getLogger(SalesReservation_HistoryLPController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
