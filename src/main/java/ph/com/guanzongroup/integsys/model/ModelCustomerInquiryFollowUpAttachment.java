 ...
 * @author User
 */
public class ModelCustomerInquiryFollowUpAttachment {
    ...
    public static ObservableList<String> documentType = FXCollections.observableArrayList("Miscellaneous");

    public ModelCustomerInquiryFollowUpAttachment(String index01,
                                                  String index02,
                                                  String index03,
                                                  String index04,
                                                  String index05,
